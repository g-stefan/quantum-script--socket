...
echo -^> local-release quantum-script-extension-socket
...
call :cmdX xyo-cc quantum-script-extension-socket --archive-release-sha512 --version-file=source/quantum-script-extension-socket.version.ini
